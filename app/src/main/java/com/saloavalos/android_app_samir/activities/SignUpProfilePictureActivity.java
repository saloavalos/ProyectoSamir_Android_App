...
public class SignUpProfilePictureActivity extends AppCompatActivity {
    ...
    // To check which images are uploaded
    private boolean isIneFrenteUploaded = false;
    private boolean isIneReversoUploaded = false;
    private boolean isProfilePhotoUploaded = false;
...
//                builder.setBackground(getResources().getDrawable(R.drawable.btn_white, null));
        ...
        btn_signup_continue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final StorageReference image = storageReference.child("users/" + userID + "/" + "foto_perfil.jpg");
